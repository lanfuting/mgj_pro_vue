      ...
      <div class="dv_reg">
        ...
        <div class="dv_reg_tab">
          <div class="dv_reg_now">
            <button @click="supp_toregister_post()" style="background-color: crimson; border: 0px;color: white;border-radius: 10px;">立即注册</button>
          </div>
          <h3 align="center">商家您好 请您登录</h3>
          ...
          <input @keyup.13="supp_logon()" type="text" v-model="keycode" class="form-control" style="width: 50%;" required placeholder="请输入验证码" />
          <input type="checkbox" name="rememberMe" />记住我<br />
          <div class="dv_reg_btns" style="width: 100%;text-align: center;">
            <button class="btn btn-success" @click="supp_logon()">登录</button>
  ...
  export default {
    ...
    methods: {
      ...
      supp_logon() {
        ...
        var url = "http://127.0.0.1:8082/backstage/supplierlogin";
        $.ajax(url, {
          data: {
            slogname: po.logname,
            spassword: po.password,
            keycode: po.keycode
          },
          success: function(result) {
            console.log(result.mge);
